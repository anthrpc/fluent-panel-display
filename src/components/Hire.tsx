...
const Hire: React.FC = () => {
  return (
    <div className="space-y-6 pb-10">
      ...
      <div className="border border-secondary rounded-lg p-6 mt-6 animate-element slide-in">
        <h3 className="text-xl font-medium mb-4">What I Can Offer</h3>
        
        <ul className="space-y-3">
          <li className="flex items-start animate-element slide-in">
      ...
      <div className="mt-8 animate-element slide-in">
        <a 
